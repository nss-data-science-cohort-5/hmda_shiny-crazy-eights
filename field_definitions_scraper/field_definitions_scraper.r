...
# BRYAN FINLAYSON'S FIELD DEFINITIONS SCRAPER --

# https://github.com/nss-data-science-cohort-5/hmda_shiny-crazy-eights/blob/bryan_branch/field_definitions_scraper.R
